import { ContentType, BlockData, UUID } from '../../../types/bklog';
...
function resetBlockHandler (state: BklogState, action: ReturnType<typeof resetBlock>) {
  return initialState;
}

function addBlockHandler (state: BklogState, action: ReturnType<typeof addBlock>) {
...
function editAbleBlockHandler (state: BklogState, action: ReturnType<typeof editAble>) {
...
function editBlockHandler (state: BklogState, action: ReturnType<typeof editBlock>) {
...
function changeTextStyleHandler (state: BklogState, action: ReturnType<typeof changeTextStyle>) {
  const { 
